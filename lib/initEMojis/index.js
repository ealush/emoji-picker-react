...
import { EMOJI_PROPERTY_UNIFIED, EMOJI_PROPERTY_NAME, EMOJI_PROPERTY_SORT_ORDER, EMOJI_PROPERTY_SKIN_VARIATIONS } from '../../src/lib/constants';

const emojis = JSON.parse(JSON.stringify(pretty).toLowerCase());

const cleanEmoji = (emoji) => {
    emoji[EMOJI_PROPERTY_NAME] = emoji.name;
